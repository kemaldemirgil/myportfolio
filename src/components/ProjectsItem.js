...
import { faWindowRestore, faSitemap, faChevronRight, faCaretRight } from "@fortawesome/free-solid-svg-icons";
        ...
        <div className="row">
            ...
            <div className="col-lg-7" data-aos="fade-left" data-aos-duration="2000">
                ...
                {props.tech.map((tech, idx) => (
                    <span className="badge" key={idx}><FontAwesomeIcon icon={faCaretRight} style={{fontSize: "70%"}}/> {tech}</span>
                ))}
                <br/>
                <div className="buttons">
                    <button type="button" className="btn btn-outline-secondary">
                    <a href={props.github} target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faGithub}/> Repo</a>
                    </button>
                    {props.deployed &&
                    <button type="button" className="btn btn-outline-secondary">
                        <a href={props.deployed} target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faWindowRestore}/> Deployed App</a>
                    </button>
                    }
                </div>
            </div>
