...
import { faLaptopCode, faFileCode, faCodeBranch } from "@fortawesome/free-solid-svg-icons";
                ...
                <div className="fluid-container">
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-8" data-aos="fade-right">
                            <p className="kd-info" ><span style={{ color: "#e1b32c", fontSize: "3rem"}}>Hello friend!</span><br/>
                            My journey in Web Development started with the Carleton University <i>Full Stack Web Development</i> Boot Camp in <b>January 2021</b> and since then, 
                            I've been working on building web &amp; computer applications using several tools and languages.
                            I have a great interest in <i>Software development,</i> <i>Cybersecurity</i> and <i>Game Development;</i> I'm hoping to continue my path towards this direction.
                            <br/>
                            I come from a multi-cultural background while having the chance to experience several jobs and positions since childhood. 
                            Whenever I get the chance, I love to spend time in the nature and to go camping; I also enjoy cooking, gardening and reading books.
                            </p>
                        </div>
                    </div>
                </div>
