...
const Navbar = () => {
    ...
    <nav className="navbar navbar-expand-lg navbar-light bg-dark">
        <div className="container-fluid">
            <a className="navbar-brand" data-aos="zoom-in" data-aos-offset="0" href="/"><img className="logo" src={logo} alt="logo"/></a>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent" data-aos="zoom-out-left" data-aos-offset="0">
                <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <a href={resume} className="nav-item" target="_blank" rel="noopener noreferrer"><li className="nav-link">Resume</li></a>
                </ul>
            </div>
        </div>
    </nav>
